...
public class SkillHuntDataFactory {
    ...
    public SkillHuntDataFactory() {
        ...
        templateDataEntriesLinks = SkillHuntData.SkillHuntDataLinks.builder()
                .offer(LINKS_OFFER_ID)
                .build();

        templateDataEntriesContact = SkillHuntData.SkillHuntDataApplication.SkillHuntDataApplicationContact.builder()
                .phone(CONTACT_PHONE)
                .city(CONTACT_CITY)
                .country(CONTACT_COUNTRY)
                .build();

        templateDataEntriesApplication = SkillHuntData.SkillHuntDataApplication.builder()
        ...
        templateDataEntries = SkillHuntData.builder()
